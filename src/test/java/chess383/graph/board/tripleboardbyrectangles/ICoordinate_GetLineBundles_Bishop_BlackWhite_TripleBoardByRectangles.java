/*
 *  ICoordinate_GetLineBundles_Bishop_BlackWhite_TripleBoardByRectangles.java
 *
...
/**
 * <p>
 * The class ICoordinate_GetLineBundles_Bishop_BlackWhite_TripleBoardByRectangles implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 ...
 *
 */
@DisplayName("the public method Set<List<String>> getLineBundles() for class ICoordinate_GetLineBundles_Bishop_BlackWhite_TripleBoardByRectangles is tested")
public class ICoordinate_GetLineBundles_Bishop_BlackWhite_TripleBoardByRectangles extends ICoordinate_GetLineBundles_Wrapper { 
    ...
    public static Stream<Arguments> stringAndListProvider() {
        return Stream.of(
            ...
            Arguments.of( "b8", Arrays.asList( "b8 a7" ) ),
        
            Arguments.of( "c1", EMPTY_STRING_LIST ),
            Arguments.of( "c2", Arrays.asList( "c2 d1" ) ),
            Arguments.of( "c3", Arrays.asList( "c3 b2 a1", "c3 d2 e1" ) ),
            Arguments.of( "c4", Arrays.asList( "c4 d3 e2 f1", "c4 b3 a2" ) ),
            Arguments.of( "c5", Arrays.asList( "c5 d4 e3 f2 g1", "c5 b4 a3" ) ),
            Arguments.of( "c6", Arrays.asList( "c6 d5 e4 f3 g2 h1", "c6 b5 a4" ) ),
            Arguments.of( "c7", Arrays.asList( "c7 b6 a5" ) ),
            Arguments.of( "c8", Arrays.asList( "c8 b7 a6" ) ),
        
            Arguments.of( "d1", EMPTY_STRING_LIST ),
            Arguments.of( "d2", Arrays.asList( "d2 e1" ) ),
            Arguments.of( "d3", Arrays.asList( "d3 e2 f1" ) ),
            Arguments.of( "d4", Arrays.asList( "d4 c3 b2 a1", "d4 e3 f2 g1" ) ),
            Arguments.of( "d5", Arrays.asList( "d5 e4 f3 g2 h1", "d5 c4 b3 a2" ) ),
            Arguments.of( "d6", Arrays.asList( "d6 c5 b4 a3" ) ),
            Arguments.of( "d7", Arrays.asList( "d7 c6 b5 a4" ) ),
            Arguments.of( "d8", Arrays.asList( "d8 c7 b6 a5" ) ),
        
            Arguments.of( "e1", EMPTY_STRING_LIST ),
            Arguments.of( "e2", Arrays.asList( "e2 f1" ) ),
            Arguments.of( "e3", Arrays.asList( "e3 f2 g1" ) ),
            Arguments.of( "e4", Arrays.asList( "e4 f3 g2 h1" ) ),
            ...
            Arguments.of( "f2", Arrays.asList( "f2 g1" ) ),
            Arguments.of( "f3", Arrays.asList( "f3 g2 h1" ) ),
            ...
            Arguments.of( "g2", Arrays.asList( "g2 h1" ) ),
            ...
            Arguments.of( "i5", Arrays.asList( "i5 d4 c3 b2 a1" ) ),
            Arguments.of( "i6", Arrays.asList( "i6 d5 c4 b3 a2" ) ),
            Arguments.of( "i7", Arrays.asList( "i7 d6 c5 b4 a3" ) ),
            Arguments.of( "i8", Arrays.asList( "i8 d7 c6 b5 a4" ) ),
            ...
            Arguments.of( "j6", Arrays.asList( "j6 i5 d4 c3 b2 a1" ) ),
            Arguments.of( "j7", Arrays.asList( "j7 i6 d5 c4 b3 a2" ) ),
            Arguments.of( "j8", Arrays.asList( "j8 i7 d6 c5 b4 a3" ) ),
            ...
            Arguments.of( "k7", Arrays.asList( "k7 j6 i5 d4 c3 b2 a1" ) ),
            Arguments.of( "k8", Arrays.asList( "k8 j7 i6 d5 c4 b3 a2" ) ),
            ...
            Arguments.of( "l8", Arrays.asList( "l8 k7 j6 i5 d4 c3 b2 a1" ) ),
