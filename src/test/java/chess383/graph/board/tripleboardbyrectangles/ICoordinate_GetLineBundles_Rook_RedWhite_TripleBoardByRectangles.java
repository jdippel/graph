...
/**
 * <p>
 * The class ICoordinate_GetLineBundles_Rook_RedWhite_TripleBoardByRectangles implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
...
public class ICoordinate_GetLineBundles_Rook_RedWhite_TripleBoardByRectangles extends ICoordinate_GetLineBundles_Wrapper { 
    ...
    public static Stream<Arguments> stringAndListProvider() {
        return Stream.of(
            ...
            Arguments.of("e9", Arrays.asList( "e9 e4 e3 e2 e1" ) ),
            Arguments.of("e10", Arrays.asList( "e10 e9 e4 e3 e2 e1" ) ),
            Arguments.of("e11", Arrays.asList( "e11 e10 e9 e4 e3 e2 e1" ) ),
            Arguments.of("e12", Arrays.asList( "e12 e11 e10 e9 e4 e3 e2 e1" ) ),
            ...
            Arguments.of("f9", Arrays.asList( "f9 f4 f3 f2 f1" ) ),
            Arguments.of("f10", Arrays.asList( "f10 f9 f4 f3 f2 f1" ) ),
            Arguments.of("f11", Arrays.asList( "f11 f10 f9 f4 f3 f2 f1" ) ),
            Arguments.of("f12", Arrays.asList( "f12 f11 f10 f9 f4 f3 f2 f1" ) ),
            ...
            Arguments.of("g9", Arrays.asList( "g9 g4 g3 g2 g1" ) ),
            Arguments.of("g10", Arrays.asList( "g10 g9 g4 g3 g2 g1" ) ),
            Arguments.of("g11", Arrays.asList( "g11 g10 g9 g4 g3 g2 g1" ) ),
            Arguments.of("g12", Arrays.asList( "g12 g11 g10 g9 g4 g3 g2 g1" ) ),
            ...
            Arguments.of("h9", Arrays.asList( "h9 h4 h3 h2 h1" ) ),
            Arguments.of("h10", Arrays.asList( "h10 h9 h4 h3 h2 h1" ) ),
            Arguments.of("h11", Arrays.asList( "h11 h10 h9 h4 h3 h2 h1" ) ),
            Arguments.of("h12", Arrays.asList( "h12 h11 h10 h9 h4 h3 h2 h1" ) ),
