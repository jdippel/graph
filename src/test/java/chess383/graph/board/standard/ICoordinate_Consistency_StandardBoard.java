...
public class ICoordinate_Consistency_StandardBoard { 

	private ICoordinate_Consistency_Wrapper wrapper = new ICoordinate_Consistency_Wrapper( ICoordinateFactory.STANDARD );
