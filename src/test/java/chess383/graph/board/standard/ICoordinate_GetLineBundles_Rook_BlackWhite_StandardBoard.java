/*
 *  ICoordinate_GetLineBundles_Rook_BlackWhite_StandardBoard.java
 *
...
/**
 * <p>
 * The class ICoordinate_GetLineBundles_Rook_BlackWhite_StandardBoard implements an upper tester
 * </p>
 *
 * @author    Jörg Dippel
 ...
 *
 */
@DisplayName("the public method Set<List<String>> getLineBundles() for class ICoordinate_GetLineBundles_Rook_BlackWhite_StandardBoard is tested")
public class ICoordinate_GetLineBundles_Rook_BlackWhite_StandardBoard extends ICoordinate_GetLineBundles_Wrapper { 
    ...
    public static Stream<Arguments> stringAndListProvider() {
        return Stream.of(
            ...
            Arguments.of( "e2", Arrays.asList( "e2 e1" ) ),
            Arguments.of( "e3", Arrays.asList( "e3 e2 e1" ) ),
            Arguments.of( "e4", Arrays.asList( "e4 e3 e2 e1" ) ),
            Arguments.of( "e5", Arrays.asList( "e5 e4 e3 e2 e1" ) ),
            Arguments.of( "e6", Arrays.asList( "e6 e5 e4 e3 e2 e1" ) ),
            Arguments.of( "e7", Arrays.asList( "e7 e6 e5 e4 e3 e2 e1" ) ),
            Arguments.of( "e8", Arrays.asList( "e8 e7 e6 e5 e4 e3 e2 e1" ) ),
            Arguments.of( "f1", EMPTY_STRING_LIST ),
            Arguments.of( "f2", Arrays.asList( "f2 f1" ) ),
            Arguments.of( "f3", Arrays.asList( "f3 f2 f1" ) ),
            Arguments.of( "f4", Arrays.asList( "f4 f3 f2 f1" ) ),
            Arguments.of( "f5", Arrays.asList( "f5 f4 f3 f2 f1" ) ),
            Arguments.of( "f6", Arrays.asList( "f6 f5 f4 f3 f2 f1" ) ),
            Arguments.of( "f7", Arrays.asList( "f7 f6 f5 f4 f3 f2 f1" ) ),
            Arguments.of( "f8", Arrays.asList( "f8 f7 f6 f5 f4 f3 f2 f1" ) ),
            Arguments.of( "g1", EMPTY_STRING_LIST ),
            Arguments.of( "g2", Arrays.asList( "g2 g1" ) ),
            Arguments.of( "g3", Arrays.asList( "g3 g2 g1" ) ),
            Arguments.of( "g4", Arrays.asList( "g4 g3 g2 g1" ) ),
            Arguments.of( "g5", Arrays.asList( "g5 g4 g3 g2 g1" ) ),
            Arguments.of( "g6", Arrays.asList( "g6 g5 g4 g3 g2 g1" ) ),
            Arguments.of( "g7", Arrays.asList( "g7 g6 g5 g4 g3 g2 g1" ) ),
            Arguments.of( "g8", Arrays.asList( "g8 g7 g6 g5 g4 g3 g2 g1" ) ),
            Arguments.of( "h1", EMPTY_STRING_LIST ),
            Arguments.of( "h2", Arrays.asList( "h2 h1" ) ),
            Arguments.of( "h3", Arrays.asList( "h3 h2 h1" ) ),
            Arguments.of( "h4", Arrays.asList( "h4 h3 h2 h1" ) ),
            Arguments.of( "h5", Arrays.asList( "h5 h4 h3 h2 h1" ) ),
            Arguments.of( "h6", Arrays.asList( "h6 h5 h4 h3 h2 h1" ) ),
            Arguments.of( "h7", Arrays.asList( "h7 h6 h5 h4 h3 h2 h1" ) ),
            Arguments.of( "h8", Arrays.asList( "h8 h7 h6 h5 h4 h3 h2 h1" ) )
